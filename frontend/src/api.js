...
const API = axios.create({ baseURL: 'http://flatbase.ap-south-1.elasticbeanstalk.com/api' });
...
export const updateListing = (id, data, config) => API.put(`/flats/update/${id}`, data, config);

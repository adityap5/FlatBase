...
`,et=e=>Ae.mutate({mutation:Ve,variables:e}),tt=e=>Ae.mutate({mutation:Be,variables:e}),at=e=>Ae.mutate({mutation:Ue,variables:e}),it=e=>Ae.query({query:De,variables:{id:e}}),rt=e=>Ae.query({query:Le,variables:{userId:e}}),st=e=>Ae.query({query:Ce,fetchPolicy:"network-only"}).then(t=>t.data.flats.filter(t=>t.seller._id===e)),nt=(e,t)=>Ae.mutate({mutation:He,variables:{id:e,...t}}),ot=e=>Ae.mutate({mutation:We,variables:{id:e}}),lt=e=>Ae.mutate({mutation:Ye,variables:{id:e}}),dt=e=>Ae.query({query:Ge,variables:{id:e}}),ct=e=>Ae.query({query:Oe,variables:{sellerId:e},fetchPolicy:"network-only"}),mt=e=>Ae.query({query:qe,variables:{sellerId:e},fetchPolicy:"network-only"}),ht=()=>Ae.query({query:Te,fetchPolicy:"network-only"}),pt=()=>Ae.query({query:Re,fetchPolicy:"network-only"}),gt=e=>Ae.query({query:Fe,variables:{flatId:e},fetchPolicy:"network-only"}),ut=e=>Ae.query({query:Me,variables:{id:e},fetchPolicy:"network-only"}),yt=e=>Ae.mutate({mutation:Ze,variables:e}),_t=e=>Ae.mutate({mutation:Ke,variables:e}),xt=k("flats/fetchFlats",async()=>(await Ae.query({query:Ce,fetchPolicy:"cache-first"})).data.flats),ft=k("flats/fetchFlatsByLocation",async e=>(await Ae.query({query:ze,variables:{location:e},fetchPolicy:"network-only"})).data.searchFlats),bt=I({reducer:{flats:$({name:"flats",initialState:{flats:[],loading:!1,error:null},reducers:{},extraReducers:e=>{e.addCase(xt.pending,e=>{e.loading=!0}).addCase(xt.fulfilled,(e,t)=>{e.loading=!1,e.flats=t.payload}).addCase(xt.rejected,(e,t)=>{e.loading=!1,e.error=t.error.message}).addCase(ft.pending,e=>{e.loading=!0}).addCase(ft.fulfilled,(e,t)=>{e.loading=!1,e.flats=t.payload}).addCase(ft.rejected,(e,t)=>{e.loading=!1,e.error=t.error.message})}}).reducer}});u.createRoot(document.getElementById("root")).render(a.jsx(p.StrictMode,{children:a.jsx(N,{store:bt,children:a.jsx(w,{client:Ae,children:a.jsx(Ie,{})})})}));export{X as A,ie as B,Qe as C,De as G,F as H,G as L,Se as R,H as U,Je as V,W as X,xt as a,pt as b,q as c,gt as d,V as e,ft as f,ht as g,at as h,rt as i,lt as j,_t as k,tt as l,st as m,ot as n,Xe as o,dt as p,it as q,et as r,K as s,Ce as t,nt as u,mt as v,ct as w,ut as x,yt as y,M as z};
